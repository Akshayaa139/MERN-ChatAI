...
import apiURL from "../../../utils"; // Go up 3 levels from src/pages/
...
const Sidebar = ({ setSelectedGroup }) => {
  ...
  const handleJoinGroup = async (groupId) => {
    try {
      ...
      await fetchGroups();
      const updatedGroups = await fetchGroups(); // Update this function to return groups
      const joinedGroup = updatedGroups.find((g) => g._id === groupId);
